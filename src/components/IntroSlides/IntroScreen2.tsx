  ...
  return (
    <Center _dark={{bg: 'blueGray.900'}} _light={{bg: 'blueGray.50'}} style={styles.bg}>
      ...
      <Box style={{height: 0.6 * height, width}}>
        ...
        <Center>
          <Text fontSize={['md', '2xl', '3xl']}>Only you have access to your seed phrases,</Text>
          <Text fontSize={['md', '2xl', '3xl']}>which can be stored up to your cloud </Text>
          <Text fontSize={['md', '2xl', '3xl']}>provider.</Text>
        </Center>
      </Box>
    </Center>
  );
