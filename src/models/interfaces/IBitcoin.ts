...
import AccountVisibility from '~models/enums/AccountVisibility';
import InitTrustedContactFlowKind from '~models/enums/InitTrustedContactFlowKind';
...
export interface TrustedContactDerivativeAccountElements extends DerivativeAccountElements {
  channelKey: string;
...
export interface DonationDerivativeAccountElements extends DerivativeAccountElements {
  donee: string;
  id: string;
  subject: string;
  description: string;
...
export interface SubPrimaryDerivativeAccountElements extends DerivativeAccountElements {
  accountName: string;
...
export interface WyreDerivativeAccountElements extends DerivativeAccountElements {
  accountName: string;
  accountDescription: string;
}
...
export interface RampDerivativeAccountElements extends DerivativeAccountElements {
  accountName: string;
  accountDescription: string;
}
...
export interface SwanDerivativeAccountElements extends DerivativeAccountElements {
  accountName: string;
  accountDescription: string;
}
